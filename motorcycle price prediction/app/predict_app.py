...
DATA = 'D:/motorcycle price prediction/data/moto_cleaned_EDA.csv'

SAVE_MODEL = 'D:/motorcycle price prediction/data/model/model.pkl'
...
def show_predict_page():
    ...
    so_km = st.number_input("Số km đã đi", min_value=0, max_value=50000, value=10000, step=1000)
